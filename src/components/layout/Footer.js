...
import { FaWhatsapp, FaPhone, FaEnvelope, FaMapMarkerAlt, FaLinkedin, FaTwitter, FaFacebook, FaInstagram, FaGlobe } from 'react-icons/fa'
        ...
        <div style={{ borderTop: '1px solid var(--border)', paddingTop: 24, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 12 }}>
          ...
          <div style={{ display: 'flex', gap: 20 }}>
            {['Privacy Policy', 'Terms of Service', 'Sitemap'].map(t => (
              <Link key={t} href="#" style={{ color: 'var(--text3)', fontSize: 13 }}>{t}</Link>
            ))}
          </div>
        </div>
      </div>
